package com.datepicker.fragments;
...
import com.datepicker.adapters.MonthAdapter;
...
public class MonthFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_month, container, false);
    }
    ...
    private void initPager(final int year, int chosenMonth) {
        ...
        mPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int month) {
                ...
                mTitle.setText(String.format(Locale.US, "%s %d", mAdapter.getPageTitle(month), year));
            }
        });
        mPager.setCurrentItem(chosenMonth);
        if (chosenMonth == 0) {
            mTitle.setText(String.format(Locale.US, "%s %d", mAdapter.getPageTitle(0), year));
        }
    }
