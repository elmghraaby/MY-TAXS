...
import com.datepicker.adapters.YearAdapter;
...
public class YearFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return LayoutInflater.from(container.getContext()).inflate(R.layout.layout_recycler_view, null);
    }
    ...
    private int[] getYears() {
        int maxYear = mCallback.getDateItem().getMaxDate().getGregorianYear();
        int minYear = mCallback.getDateItem().getMinDate().getGregorianYear();
