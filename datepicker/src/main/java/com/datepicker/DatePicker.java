...
import com.datepicker.fragments.MonthFragment;
import com.datepicker.fragments.YearFragment;
import com.datepicker.interfaces.DateInterface;
...
public class DatePicker extends DialogFragment implements OnClickListener, DateInterface {
    ...
    private String[] mWeekDaysShortcut;
...
//        mToday.setVisibility(isToday() ? View.GONE : View.VISIBLE);
        ...
        mDate.setText(getString(R.string.date_placeholder, getDayName(), mDateItem.getDay(), getMonthName()));
    }
    ...
    public String getDayName() {
        int day = mDateItem.getGregorianDay();
    ...
    @Override
    public String[] getWeekDaysٍٍShortcut() {
        if (mWeekDaysShortcut == null)
            mWeekDaysShortcut = getResources().getStringArray(R.array.en_week_days_shortcut);
        return mWeekDaysShortcut;
    }

    /**
     * @return returns week days
     */

    @Override
    public String[] getWeekDays() {
        if (mWeekDays == null)
            mWeekDays = getResources().getStringArray(R.array.en_week_days);
        return mWeekDays;
    }
    ...
    public String[] getMonths() {
        if (mMonths == null)
            mMonths = getResources().getStringArray(R.array.en_months);
        return mMonths;
    }

    private Boolean isToday() {
        return mDateItem.getYear() == mTodayDate.getGregorianYear() &&
                mDateItem.getMonth() == mTodayDate.getGregorianMonth() &&
                mDateItem.getDay() == mTodayDate.getGregorianDay();
    }
